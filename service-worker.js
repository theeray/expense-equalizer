const CACHE='eee-v1.1.0';
const ASSETS=[
  './','./index.html','./style.css','./app.js','./manifest.webmanifest',
  './assets/splash-landscape.svg',
  './icons/brand-icon-v2.png','./icons/icon-192-v2.png','./icons/icon-512-v2.png',
  './icons/apple-touch-icon-v2.png','./icons/favicon-v2.png'
];
